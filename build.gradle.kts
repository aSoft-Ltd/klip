...
subprojects {
    ...
    configure<MavenPublishBaseExtension> {
        ...
        pom {
            ...
            url.set("https://github.com/aSoft-Ltd/klip")
            licenses {
                license {
                    name.set("MIT License")
                    url.set("https://github.com/aSoft-Ltd/klip/blob/master/LICENSE")
                }
            }
            developers {
                developer {
            ...
            scm {
                url.set("https://github.com/aSoft-Ltd/klip/")
                connection.set("scm:git:git://github.com/aSoft-Ltd/klip.git")
                developerConnection.set("scm:git:ssh://git@github.com/aSoft-Ltd/klip.git")
            }
        }
    }
}
